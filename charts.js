...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var selectedIdSamples = sampArray.filter(data => data.id == sample);
    ...
    var sampValues = firstSample.sample_values;
    console.log(otuIds);
    ...
    var barLayout = {
      ...
      annotations: [{
        ...
        y: -0.25,
        yanchor: 'center',
        text: 'Top 10 bacterial species<br>with number of bacteria samples found in your belly button',
        showarrow: false
      }]
    };
    //console.log("hello");
    ...
    var gaugeData = [
      {
        domain: { x: [0, 1], y: [0, 1] },
        value: washFreq,
        title: { text: "<b>Belly Button Washing Frequency</b><br>Washing per week"},
        type: "indicator",
        mode: "gauge+number",
        gauge: {
          axis: {
